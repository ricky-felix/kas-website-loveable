...
export const Hero = () => {
  return (
    <section id="top" className="relative pt-32 md:pt-40 pb-16 md:pb-24 overflow-hidden">
      <div className="absolute inset-0 grid-paper opacity-40 pointer-events-none" aria-hidden />
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-12 md:mb-20">
          <div className="flex items-center gap-3">
            ...
            <span className="rule-label">Medan · Sumatera Utara · 03°35′N</span>
          </div>
          <span className="rule-label">Est. 2008 — Vol. XVII</span>
        </div>

        <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
          {/* Headline */}
          <div className="col-span-12 lg:col-span-7">
            <p className="rule-label mb-6">Index 01 / Architectural Waterproofing</p>
            <h1 className="display-serif text-[14vw] md:text-[8.5vw] lg:text-[7rem] xl:text-[8.5rem] leading-[0.9] tracking-tighter">
              Built to
              <br />
              outlast
              <br />
              the <span className="italic text-cobalt">monsoon</span>.
            </h1>
          ...
          <div className="col-span-12 lg:col-span-5 lg:pl-8">
            <p className="text-base md:text-lg text-muted-foreground max-w-[40ch] leading-relaxed">
              <span className="text-foreground font-medium">STRATA</span> is a Medan-based
              waterproofing studio working at the seam of architecture and engineering.
              Membranes, coatings, injections — specified, installed, guaranteed.
            </p>
            ...
            <dl className="mt-12 grid grid-cols-3 gap-4">
              {[
                { k: "17", l: "years", c: "outline-cobalt" },
                { k: "240+", l: "projects", c: "outline-rust" },
                { k: "10y", l: "warranty", c: "outline-ochre" },
              ].map((s) => (
        ...
        <figure className="relative mt-16 md:mt-24">
          <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden rounded-sm outline-ink">
            <img
              src={heroImg}
              alt="Water cascading down a raw concrete architectural wall, illustrating waterproofing performance"
              width={1280}
              height={720}
            ...
            <div className="absolute left-4 top-4 md:left-6 md:top-6 px-3 py-1.5 bg-background/90 backdrop-blur outline-cobalt rounded-sm">
              <span className="rule-label">Plate 001 — Sheet flow test</span>
            </div>
            <div className="absolute right-4 bottom-4 md:right-6 md:bottom-6 px-3 py-1.5 bg-background/90 backdrop-blur outline-rust rounded-sm">
              <span className="rule-label">Tropical exposure · 2,300 mm/yr</span>
            </div>
          </div>
        </figure>
      </div>
