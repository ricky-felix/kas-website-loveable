      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-12 md:mb-20">
          <div className="flex items-center gap-3">
            ...
            <span className="rule-label">Medan · Sumatera Utara · 03°35′LU</span>
          </div>
          <span className="rule-label">Berdiri 2008 — Vol. XVII</span>
        </div>

        <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
          {/* Headline */}
          <div className="col-span-12 lg:col-span-7">
            <p className="rule-label mb-6">Indeks 01 / Waterproofing Arsitektural</p>
          ...
          <div className="col-span-12 lg:col-span-5 lg:pl-8">
            <p className="text-base md:text-lg text-muted-foreground max-w-[40ch] leading-relaxed">
              <span className="text-foreground font-medium">PT Karya Agung Sejati</span> adalah
              studio waterproofing yang berbasis di Medan, bekerja di antara arsitektur dan
              rekayasa. Membran, pelapis, injeksi — dispesifikasi, dipasang, dijamin.
            </p>
            ...
            <dl className="mt-12 grid grid-cols-3 gap-4">
              {[
                { k: "17", l: "tahun", c: "outline-cobalt" },
                { k: "240+", l: "proyek", c: "outline-rust" },
                { k: "10thn", l: "garansi", c: "outline-ochre" },
              ].map((s) => (
        ...
        <figure className="relative mt-16 md:mt-24">
          <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden rounded-sm outline-ink">
            ...
            <div className="absolute right-4 bottom-4 md:right-6 md:bottom-6 px-3 py-1.5 bg-background/90 backdrop-blur outline-rust rounded-sm">
              <span className="rule-label">Iklim tropis · 2.300 mm/thn</span>
            </div>
          </div>
        </figure>
      </div>
