				...
				<div className="grid grid-cols-12 gap-8 mb-16">
					...
					<div className="col-span-12 md:col-span-7 md:col-start-6 self-end">
						<p className="text-lg text-muted-foreground max-w-[55ch]">
							Setiap proyek diawali dengan survei, spesifikasi tertulis, dan
							pemilihan material yang sesuai dengan substrat, paparan cuaca,
							serta tujuan klien.
						</p>
					</div>
				</div>
					...
					{services.map((s) => (
						...
						>
							<div className="flex items-baseline justify-between mb-8">
								<span className={`display-serif text-2xl ${s.text}`}>
									{s.no}
								</span>
							</div>
							<h3 className="display-serif text-2xl md:text-3xl mb-4 leading-tight">
								{s.title}
							</h3>
